...
const Packages = () => {
    ...
    const { accountData, showErrorToast } = useAccount();
    ...
    const handlePayment = async (pkg) => {
        ...
        try {
            ...
            if (response.data.payment_url) {
                ...
                showErrorToast("Payment failed: " + JSON.stringify(response.data));
            }
        } catch (error) {
                ...
                {loading ? (
                    <div className="max-w-md mx-auto">
                        <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-12 text-center border border-white/30">
                            ...
                            <h3 className="text-2xl font-bold text-[#5842aa] mb-4"> Please Wait, a payment gateway will open</h3>
